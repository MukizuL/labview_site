  ...
  return (
    <>
      ...
      <div className="Module1-main-container">
        ...
        img[0].src = "public/images/img-1.jpg"; img[0].stlyle = "margin-left:
        500px"
        <p>
        ...
        img[1].src = "public/images/img-2.jpg"; img[1].stlyle = "margin-left:
        300px"
        <p className="style">
          Оба окна имеют линейки инструментов, имеющие служебные кнопки:
        </p>
        img[2].src = "public/images/img-3.jpg"; img[2].stlyle = "margin-left:
        430px"
        <p>
        ...
        img[3].src = "public/images/img-4.jpg"; img[3].stlyle = "margin-left:
        460px"
        <p>
        ...
        img[4].src = "public/images/img-5.jpg"; img[4].stlyle = "margin-left:
        400px"
        <p>
        ...
        img[5].src = "public/images/img-6.jpg"; img[5].stlyle = "margin-left:
        400px"
        <p>
        ...
        img[6].src = "public/images/img-7.jpg"; img[6].stlyle = "margin-left:
        450px"
        <p>
        ...
        img[7].src = "public/images/img-8.jpg"; img[7].stlyle = "margin-left:
        450px"
        <p>
        ...
        img[8].src = "public/images/img-9.jpg"; img[8].stlyle = "margin-left:
        450px"
        <p>
        ...
        img[9].src = "public/images/img-10.jpg"; img[9].stlyle = "margin-left:
        500px"
        <p>
        ...
        img[10].src = "public/images/img-11.jpg"; img[10].stlyle = "margin-left:
        500px"
        <p>
        ...
        img[11].src = "public/images/img-12.jpg"; img[11].stlyle = "margin-left:
        450px"
        <p>
          Теперь нажмем на{" "}
        ...
        img[12].src = "public/images/img-13.jpg"; img[12].stlyle = "margin-left:
        450px"
        <p>
        ...
        img[13].src = "public/images/img-14.jpg"; img[13].stlyle = "margin-left:
        430px"
        <p>
        ...
        img[14].src = "public/images/img-15.jpg"; img[14].stlyle = "margin-left:
        430px"
        <p>
        ...
        img[15].src = "public/images/img-16.jpg"; img[15].stlyle = "margin-left:
        500px"
        <p>
        ...
        img[16].src = "public/images/img-17.jpg"; img[16].stlyle = "margin-left:
        500px"
        <p>
        ...
        img[17].src = "public/images/img-18.jpg"; img[16].stlyle = "margin-left:
        500px"
        <p>
          Так как кроме входа "
        ...
        img[18].src = "public/images/img-19.jpg"; img[18].stlyle = "margin-left:
        500px"
        <p>
        ...
        img[19].src = "public/images/img-20.jpg"; img[19].stlyle = "margin-left:
        450px"
        <p>
        ...
        img[20].src = "public/images/img-21.jpg"; img[20].stlyle = "margin-left:
        250px"
      </div>
    </>
  );
